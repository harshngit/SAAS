...
export default function ListActionMenu({ items = [], align = 'right', className = '', triggerClassName = '' }) {
          ...
          >
            {items.map((item) => (
              <button
                ...
                className={`flex w-full items-center gap-2 rounded-lg disabled:cursor-not-allowed disabled:opacity-40 px-3 py-2 text-left text-sm transition-colors ${
